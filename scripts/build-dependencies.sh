...
function alert_to_install_carthage {
    echo "error: Carthage was not found! In order to build DGCharts you need to use Carthage to build its dependencies. Carthage can be downloaded from https://github.com/Carthage/Carthage."
    exit 1
}
